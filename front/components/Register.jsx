    ...
    <div className="osahan-signup">
      <div className="osahan-header-nav shadow-sm p-3 d-flex align-items-center bg-danger">
        <h5 className="font-weight-normal mb-0 text-white">
          <a className="text-danger mr-3" href="/"><i className="icofont-rounded-left"></i></a> Create an account
        </h5>
      </div>
      <div className="p-3">
        <form action="#">
        ...
        <div className="osahan-signin text-center p-1">
          <p className="m-0">Already a member? <a href="/login" className="text-danger ml-2">Sign In</a></p>
        </div>
      </div>
    </div>
  );
