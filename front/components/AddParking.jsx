                ...
                <div className="d-flex small">
                    <form className="w-100" action="javascript:;">
                        <div className="form-group mb-3">
                            ...
                            <input className="form-control form-control-sm" placeholder="Enter the parking slot"></input>
                        </div>
                        <button type="submit" className="btn btn-danger btn-block" data-toggle="modal" data-target="#successAddParking">Add</button>
                    </form>
                </div>
            </div>
            <div className="modal fade" id="successAddParking" data-backdrop="static" tabIndex="-1" data-keyboard="false">
